...
var User = function User(itemA, itemB) {
    _classCallCheck(this, User);

    var obs = Rx.Observable.of(itemA, itemB);
    var sum$ = obs.reduce(function (acc, item) {
        return acc + item;
    });
    return {
        observable: sum$
...
var Recived = function Recived(observable) {
...
var recvie = new Recived(user.observable);
